...
namespace Niind
{
    ...
    public class Constants
    {
        ...
        public static readonly byte[] EmptyFST = new byte[0x20];

        //  public static readonly byte[] EmptyPageRawData = new byte[NandPageNoSpareByteSize];
        public static readonly byte[] EmptyClusterRawData = new byte[NandClusterNoSpareByteSize];
        public static readonly byte[] SuperBlockHeader = Encoding.ASCII.GetBytes("SFFS");


        // public static readonly string WiiShopUserAgent =
        //     "Opera/9.00 (Nintendo Wii; U; ; 1038-58; Wii Shop Channel/1.0; en)";

        public static readonly string UpdaterUserAgent = "wii libnup/1.0";
        // public static readonly string VirtualConsoleUserAgent = "libec-3.0.7.06111123";
        //
        // public static readonly string WiiConnect24UserAgent = "WiiConnect24/1.0FC4plus1 (build 061114161108)";

        public static readonly Uri NUSBaseUrl = new("http://nus.cdn.shop.wii.com/ccs/download/");


        public static readonly List<(ulong TicketID, uint Version)> Version4_3U_Titles = new()
        {
            (0x100000002, 0x201),
            (0x100000004, 0xFF00),
            (0x100000009, 0x40A),
